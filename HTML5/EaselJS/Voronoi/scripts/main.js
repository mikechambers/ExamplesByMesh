...
var ex = [];
var ey = [];
var INITIAL_DOT_COUNT = 25;
var fpsText;
var storageSize;

var drawColor = Graphics.getRGB(255,255,255,.7);
var dotRadius = 2;
...
function initDots() {
	...
	for (i=0; i<INITIAL_DOT_COUNT; i++) {
		addDot(Math.random()*appW, Math.random()*appH, g);
	}
}

function addDot(x, y, g) {
	dots[dotNum] = {};
	dots[dotNum].x = x;
	dots[dotNum].y = y;
